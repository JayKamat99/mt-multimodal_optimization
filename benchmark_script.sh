...
# ../build/t_main # run the algorithm on PathOptimizerKOMO and visualize the paths
...
for MODEL in {"1_kuka_shelf","4_kuka_box","5_disc_obstacle","6_rectangle_opening","7_disc_rooms"}
do
...
#../build/t_main "../examples/Models/$MODEL.g" "PathSimplifier" "true"
#python3 ../ompl/scripts/ompl_benchmark_statistics.py data/Benchmarks/benchmark_PathSimplifier.log -d data/$MODEL/Benchmarks/benchmark_PathSimplifier.db

../build/t_main "../examples/Models/$MODEL.g" "RRTstar" "true"
python3 ../ompl/scripts/ompl_benchmark_statistics.py data/Benchmarks/benchmark_RRTstar.log -d data/Benchmarks/$MODEL/benchmark_1.db

../build/t_main "../examples/Models/$MODEL.g" "BITstar" "true"
python3 ../ompl/scripts/ompl_benchmark_statistics.py data/Benchmarks/benchmark_BITstar.log -d data/Benchmarks/$MODEL/benchmark_BITstar.db

../build/t_main "../examples/Models/$MODEL.g" "LBTRRT" "true"
python3 ../ompl/scripts/ompl_benchmark_statistics.py data/Benchmarks/benchmark_LBTRRT.log -d data/Benchmarks/$MODEL/benchmark_LBTRRT.db

# ../build/t_main "../examples/Models/$MODEL.g" "FMT" "true"
# python3 ../ompl/scripts/ompl_benchmark_statistics.py data/Benchmarks/benchmark_FMT.log -d data/Benchmarks/$MODEL/benchmark_FMT.db

cd data
python3 plot_both.py $MODEL
cd ..
