...
# do
    ...
    do 
        ...
        python3 ../ompl/scripts/ompl_benchmark_statistics.py data/Benchmarks/benchmark_$PLANNER.log -d data/Benchmarks/$MODEL/benchmark_$PLANNER.db # make the database file out of the log file
    done
