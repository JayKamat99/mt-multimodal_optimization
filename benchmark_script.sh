...
# ../build/t_manip "../examples/Models/2D_arm.g" "KOMO" "true" # run the executable
...
# ../ompl/scripts/ompl_benchmark_statistics.py data/Benchmarks/benchmark_PathSimplifier.log -d data/Benchmarks/benchmark_multimodal.db # make the database file out of the log file
